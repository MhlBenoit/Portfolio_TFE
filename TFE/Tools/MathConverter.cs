/*
 * Copyright (c) 2011 by Ivan Krivyakov
 *
 * -> https://ikriv.com/dev/wpf/MathConverter/
 * 
 * Ceci ne me sert juste qu'à diviser le prix total par la quantitée, afin de déterminer le prix d'achat unitaire pour certains datagrid
 */
        ...
        IValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            try
            {
                ...
                if (targetType == typeof(string)) return result.ToString("0.00 €");
